...
<head>
    ...
    <link rel="stylesheet" href="/control_almacen/fontAwesome/fontawesomeregular.css">
                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                            <img src="/control_almacen/img/LogoEmpresa.png" alt="logo" width="40">
                            <span class="fs-4 fw-bold ms-2 text-white">SI - UniCenter</span>
                        </a>
